...
**Xiaolong Ma** is currently a Postdoctoral Appointee in the [Data Science and Learning (DSL) Division](https://www.anl.gov/dsl) at [Argonne National Laboratory](https://www.anl.gov/), supervised by Dr. [Rajkumar Kettimuthu](https://www.mcs.anl.gov/~kettimut/). He received his Ph.D. in Computer Science from University of Nevada, Reno, advised by Prof. [Feng Yan](https://www2.cs.uh.edu/~fyan/index.html) and Prof. [Lei Yang](https://www.cse.unr.edu/~lyang/). His research lies at the intersection of high-performance computing, distributed system and **machine learning system**, with a particular focus on building scalable, efficient, and reliable infrastructure for large-scale AI training and inference.
